...
# Warnings indicate that you have a participant that did the study more than once (because their folder already exists)
# They are fine to ignore, but worth double checking by viewing the errors if this is the first time running this code.
